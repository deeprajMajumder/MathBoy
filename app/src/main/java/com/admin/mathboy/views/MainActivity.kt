...
fun MainScreen(innerPadding: PaddingValues, mainViewModel: MainViewModel) {
    ...
    LazyColumn(
        ...
        item {
            OutlinedTextField(
                value = input1,
                onValueChange = { input1 = mainViewModel.formatInput(it) },
        ...
        item {
            OutlinedTextField(
                value = input2,
                onValueChange = { input2 = mainViewModel.formatInput(it) },
        ...
        item {
            OutlinedTextField(
                value = input3,
                onValueChange = { input3 = mainViewModel.formatInput(it) },
        ...
        item {
            if (isButtonClicked) {
                if (input1.isEmpty() && input2.isEmpty() && input3.isEmpty()) {
                    Text("Please enter at least one number")
                } else {
